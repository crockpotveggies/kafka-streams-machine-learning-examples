 ...
 */
public class Kafka_Streams_MachineLearning_DL4J_Keras_Import_Iris_IntegrationTest {
	...
	private String locationKerasModel = "src/main/resources/generatedModels/keras/keras-iris.h5";
	...
	public void shouldPredictIrisFlowerType() throws Exception {
		...
		MultiLayerNetwork model = KerasModelImport.importKerasSequentialModelAndWeights(locationKerasModel);
